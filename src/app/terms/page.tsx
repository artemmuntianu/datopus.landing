        ...
        <main className="flex flex-col min-h-[100dvh] mt-[3.5rem] [background-image:linear-gradient(to_bottom,hsl(var(--primary)/10%),transparent)] [background-size:100%_50rem] [background-repeat:no-repeat]">
            ...
            <div className="mx-auto max-w-screen-xl px-4 space-y-6">
                <section>
                    ...
                    <p className="leading-relaxed">These Terms of Service (&quot;Terms&quot;) govern your use of our feature analysis platform (&quot;Service&quot;). By accessing or using the Service, you agree to be bound by these Terms. If you do not agree, do not use the Service.</p>
                </section>
                <section>
                ...
                <section>
                    ...
                    <p className="leading-relaxed">Datopus provides tools for feature analysis, user behavior tracking, and data visualization. Features and functionalities may be updated, modified, or removed at any time at our discretion.</p>
                </section>
                <section>
