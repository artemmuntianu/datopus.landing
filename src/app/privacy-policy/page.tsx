        ...
        <main className="flex flex-col min-h-[100dvh] mt-[3.5rem] [background-image:linear-gradient(to_bottom,hsl(var(--primary)/10%),transparent)] [background-size:100%_50rem] [background-repeat:no-repeat]">
            ...
            <div className="mx-auto max-w-screen-xl px-4 space-y-6">
                <section>
                    ...
                    <p className="leading-relaxed">Datopus (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) values your privacy. This Privacy Policy outlines how we collect, use, and protect your information when you use our feature analysis platform (&quot;Service&quot;). By using our Service, you agree to the practices described in this policy.</p>
                </section>
                <section>
                ...
                <section>
                    ...
                    <p className="leading-relaxed">We implement industry-standard security measures to protect your data from unauthorized access, alteration, or disclosure. However, no method of transmission or storage is completely secure, and we cannot guarantee absolute security.</p>
                </section>
                <section>
                    <h2 className="text-xl font-semibold mb-2">5. Data Retention</h2>
                    <p className="leading-relaxed">We retain your data for as long as necessary to provide the Service or as required by law. Upon termination of your account, we will delete or anonymize your data, unless retention is required for legal purposes.</p>
                </section>
                <section>
                ...
                <section>
                    ...
                    <p className="leading-relaxed">Our platform integrates with third-party services like Google Analytics and Google BigQuery. We are not responsible for the privacy practices of these services. Please review their respective privacy policies for more information.</p>
                </section>
                <section>
                    <h2 className="text-xl font-semibold mb-2">8. International Data Transfers</h2>
                    <p className="leading-relaxed">If you are accessing our Service from outside Portugal, your information may be transferred to and processed in a country with different data protection laws. By using our Service, you consent to such transfers.</p>
                </section>
                <section>
                    <h2 className="text-xl font-semibold mb-2">9. Changes to this Privacy Policy</h2>
                    <p className="leading-relaxed">We may update this Privacy Policy periodically. Any changes will be posted on this page with an updated &quot;Effective Date.&quot; Your continued use of the Service after changes constitutes acceptance of the updated policy.</p>
                </section>
                <section>
                    <h2 className="text-xl font-semibold mb-2">10. Contact Us</h2>
                    <p className="leading-relaxed">If you have any questions or concerns about this Privacy Policy, please contact us at <a href="mailto:artem@datopus.io" className="text-blue-600 underline">artem@datopus.io</a>.</p>
                </section>
            </div>
