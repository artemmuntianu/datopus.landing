...
export default function Page() {
    return (
        <main className="flex flex-col min-h-[100dvh] mt-[3.5rem] space-y-10 [background-image:linear-gradient(to_bottom,hsl(var(--primary)/10%),transparent)] [background-size:100%_50rem] [background-repeat:no-repeat]" data-ds-feature="homepage-main">
            ...
            <section id="hero" className="max-w-screen-xl mx-auto" data-ds-feature="hero-section">
                ...
                <BlurFade delay={BLUR_FADE_DELAY * 1} yOffset={0}>
                    <ShineBorder
                        ...
                        data-ds-feature="hero-video-container"
                    >
                        <HeroVideoDialog
                            className="block"
                            animationStyle="fade"
            ...
            <section id="platform" className="py-16" data-ds-feature="platform-section">
            ...
            <section id="security-standards" className="py-16 bg-[hsl(var(--primary)/5%)]" data-ds-feature="security-section">
            ...
            <section id="how-it-works" className="max-[1200px]:hidden py-16" data-ds-feature="how-it-works-section">
            ...
            <section id="faq" className="py-16" data-ds-feature="faq-section">
            ...
            <section id="cta" className="w-full py-14 bg-blue-600 md:py-28" data-ds-feature="main-cta-section">
