...
export const whatWeCanDo = [
    ...
    },
    {
        ...
        subtitleItems: <div className="space-y-4">
            <div className="flex items-center gap-4">
                <div className="text-neutral-700">⭐</div>
                <div>
